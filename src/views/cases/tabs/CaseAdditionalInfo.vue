            ...
            <v-flex xs12 sm12 md12 lg12 xl12>
                        ...
                        <v-layout row wrap>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.first_name" :label="$t('case.first_name')"
                                              :rules="[rules.required]"
                                              class="textField"></v-text-field>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.last_name" :label="$t('case.last_name')"
                                              :rules="[rules.required]"
                                              class="textField"></v-text-field>
                            </v-flex>
                            ...
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-menu v-model="dateOfBirthMenu" :close-on-content-click="false" :nudge-right="40"
                                    ...
                                    <template v-slot:activator="{ on }">
                                        <v-text-field :class="{'disable-events': true }"
                                                      v-model="caseObject.date_of_birth"
                                                      :label="$t('case.date_of_birth')"
                            ...
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="genderOptions" v-model="caseObject.gender"
                                          :label="$t('case.gender')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-menu v-model="contactedDateMenu" :close-on-content-click="false" :nudge-right="40"
                                    ...
                                    <template v-slot:activator="{ on }">
                                        <v-text-field :class="{'disable-events': true }"
                                                      v-model="caseObject.contacted_date"
                            ...
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.father_fullname"
                                              :label="$t('case.father_full_name')" class="textField"></v-text-field>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.mother_fullname"
                            ...
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="isRefugeeOptions"
                            ...
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.home_country"
                                              :label="$t('case.home_country')"
                                              class="textField"></v-text-field>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.home_address"
                            ...
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.birth_country"
                                              :label="$t('case.birth_country')"
                                              class="textField"></v-text-field>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.nationality" :label="$t('case.nationality')"
                                              class="textField"></v-text-field>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model="caseObject.religion" :label="$t('case.religion')"
                                              class="textField"></v-text-field>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model.number="caseObject.languages_spoken"
                                    ...
                                    <v-layout wrap>
                                        <v-flex xs12 sm12 md6 lg6 xl6>
                                            <v-text-field :class="{'disable-events': true }"
                                                          ...
                                                          :rules="[rules.required]"
                                                          :label="$t('case.latitude')" placeholder="-" disabled
                                                          style="padding: 5px 15px;"
                                                          prepend-icon="my_location"></v-text-field>
                                        </v-flex>
                                        <v-flex xs12 sm12 md6 lg6 xl6>
                                            <v-text-field :class="{'disable-events': true }"
                                                          v-model="feedbackObject.longitude"
                                                          :rules="[rules.required]"
                                                          class="header-text-field-input"
                                        ...
                                        <v-flex xs12 sm12 md3 lg3 xl3>
                                            <v-select :class="{'disable-events': true }" :items="childStatuses"
                                                      v-model="feedbackObject.child_status"
                                                      :label="$t('case.child_status')" style="padding: 5px 15px;">
                                            </v-select>
                                        </v-flex>
                                        <v-flex xs12 sm12 md3 lg3 xl3>
                                            <v-select :class="{'disable-events': true }" :items="transportationChoices"
                                                      v-model="feedbackObject.transportation"
                                                      :label="$t('case.transportation')" style="padding: 5px 15px;">
                                            </v-select>
                                        </v-flex>
                                    </v-layout>
                                </v-flex>
                                    ...
                                    <v-layout row wrap>
                                        ...
                                        <v-flex xs12 sm12 md6 lg6 xl6>
                                            <v-textarea disabled name="input-7-1"
                                                        ...
                                                        :placeholder="$t('case.transit_country_placeholder')" auto-grow
                                                        rows="2"
                                                        style="padding: 5px 15px;"
                                        ...
                                        <v-flex xs12 sm12 md3 lg3 xl3>
                                            <v-checkbox disabled v-model="caseObject.volunteers_utilized"
                                                        :label="$t('case.has_volunteers')"
                                                        style="padding: 5px 15px;"></v-checkbox>
                                        </v-flex>
                                        <v-flex xs12 sm12 md3 lg3 xl3>
                                            <v-checkbox disabled v-model="caseObject.rescue_teams_utilized"
                    ...
                    <v-card-text>
                        <v-layout row wrap>
                            ...
                            <v-flex xs12 sm12 md6 lg6 xl6>
                                <v-layout row wrap>
                                    <v-flex xs12 sm12 md12 lg12 xl12>
                                        <v-switch disabled v-model="caseObject.amber_alert"
                                                  :label="$t('case.amber_alert')" style="padding: 5px 15px;"></v-switch>
                                    </v-flex>
                                    <v-flex xs12 sm12 md12 lg12 xl12>
                                        <v-textarea disabled name="input-7-1"
                ...
                <v-card color="grey lighten-5" class="mb-5" style="padding: 15px;">
                    ...
                    <v-card-text>
                        <v-layout row wrap>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="triggeredEventOptions"
                                          v-model="caseObject.triggered_event"
                                          :label="$t('case.has_trigger_event')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="concernOptions" v-model="caseObject.concerns"
                                          :label="$t('case.has_family_issues')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="disappearanceReasonsOptions" v-model="caseObject.disappearance_reasons"
                                          :label="$t('case.dis_reasons')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="disorderOptions"
                                          v-model="caseObject.mental_disorders"
                                          :label="$t('case.mental_disorders')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="disorderOptions"
                                          ...
                                          :label="$t('case.psychological_disorders')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="addictionOptions"
                                          ...
                                          :label="$t('case.disabilities')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="livingEnvironmentOptions" v-model="caseObject.living_environment"
                                          :label="$t('case.living_env')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="parentsProfileOptions"
                                          v-model="caseObject.parents_profile"
                                          :label="$t('case.parent_issues')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-select :class="{'disable-events': true }" :items="relationshipOptions"
                                          v-model="caseObject.relationship_status"
                                          :label="$t('case.relationship')" item-text="text" item-value="value"
                                          style="padding: 5px 15px;">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3 lg3 xl3>
                                <v-text-field :class="{'disable-events': true }"
                                              v-model.number="caseObject.family_members"
                        ...
                        <v-layout row wrap>
                            ...
                            <v-flex xs12 sm12 md12 lg12 xl12>
                                <v-textarea disabled name="input-7-1"
                                            ...
                                            :label="$t('case.description')"
                                            :placeholder="$t('case.description_health_placeholder')" auto-grow rows="4"
                                            style="padding: 10px 15px;"
                                            counter maxlength="5000">
                                </v-textarea>
                            </v-flex>
                    ...
                    <v-card-text>
                        <v-layout v-for="socialMediaItem in socialMedia" :key="socialMediaItem.medium" row wrap>
                            ...
                            <v-flex xs12 sm12 md3>
                                <v-select :class="{'disable-events': true }" :items="publishedPhotosOptions"
                            ...
                            <v-flex xs12 sm12 md3>
                                <v-select :class="{'disable-events': true }" :items="followersOptions"
                                          v-model="socialMediaItem.followers"
                                          :label="$t('case.followers')" item-text="text" item-value="value" class="noPadding mx-2">
                                </v-select>
                            </v-flex>
                            <v-flex xs12 sm12 md3>
                                <v-select :class="{'disable-events': true }" :items="recentActivityOptions"
                                          v-model="socialMediaItem.recent_activity"
                                          :label="$t('case.recent_activity')" item-text="text" item-value="value" class="noPadding mx-2">
                                </v-select>
                            </v-flex>
                        </v-layout>
                    </v-card-text>
...
export default {
    ...
    methods: {
        ...
        validateForm() {
            if (!this.editMode) {
                this.isFormValid = !!(this.caseObject.first_name && this.caseObject.last_name && this.caseObject.custom_name && this.caseObject.gender && this.caseObject.date_of_birth && this.feedbackObject.address && this.feedbackObject.latitude && this.feedbackObject.longitude
                    && this.feedbackObject.date);
            } else {
                this.isFormValid = !!(this.caseObject.first_name && this.caseObject.last_name && this.caseObject.custom_name && this.caseObject.gender && this.caseObject.date_of_birth);
            }
        },
        setPlace(place) {
            this.markers = [];
