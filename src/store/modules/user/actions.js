...
//                 localStorage.setItem('organization_id', response.data.organization);
//                 localStorage.setItem('user_role', response.data.role);
//                 if (response.data.role === 'facility_manager') {
//                     localStorage.setItem('facility_id', response.data.facility);
//                 } else {
//                     localStorage.setItem('facility_id', null);
//                 }
//             }
//             return response;
//         })
