...
// //     const params = {};
// //     return casesApi.getActiveCases(localStorage.getItem('access_token'), params)
// //         .then((response) => {
// //             if (response.status === 200) {
// //                 commit(UPDATE_ACTIVE_CASES, response.data);
// //             }
// //             return response;
// //         })
// //         .catch(error => Promise.reject(error));
...
// export const getFacilityCasesAction = ({ commit, state, dispatch }) => {
//     const params = {};
//     return casesApi.getFacilityCases(localStorage.getItem('access_token'), params)
//         .then((response) => {
//             if (response.status === 200) {
//                 commit(UPDATE_FACILITY_CASES, response.data);
//             }
//             return response;
//         })
//         .catch(error => Promise.reject(error));
...
//     return casesApi.editCase(caseObject.id, caseObject)
//         .then((response) => {
//             if (response.status === 200) {
//                 commit(UPDATE_CASES, response.data);
//             }
